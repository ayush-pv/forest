       ...
       <div className='home'>
            <div className='home_head'>
                <div className='home_left'>
                    ...
                    <p className='home_selectone'><ArrowForwardIosIcon/>Andhra Pradesh<select className='home_select'>
                        <option value='meghalaya'>andhra pradesh</option>
                    ...
                    <div className='home_statement'>
                        <p>In 2010, <strong>Andhra Pradesh</strong> had <strong>979kha</strong> of natural forest, extending over <strong>6.2%</strong> of its land area. In 2020, 
                            it <strong>lost 1.38kha</strong> of natural forest, equivalent to <strong>618kt of CO₂</strong> of emissions.</p>
                    </div>
                </div>
            ...
            <div className='home_explore'>
                <p>Explore Graphs and basic Data information to know about the loss in the total tree cover area taken place in Andhra Pradesh between the years <strong>2001</strong> to <strong>2020</strong> </p>
            </div>
            <div className='home_body'>
                <Graph
                    titleone='FROM 2002 TO 2020'
                    title='Here ia a graph showing decline in the total tree cover in Andhra Pradesh.'
                    image='11.jpg'
                />
            ...
            <div className='home_body_two'>
                ...
                />
                <Content
                    titleagain='Tree Cover Loss in Andhra Pradesh'
                    info='Top 5 regions responsible for maximum tree cover loss in Assam between the years 2001 and 2020 are:-'
                    p1='VISSHAKAPATNAM'
                    p2='EAST GODHAVARI'
                    p3='WAST GODHAVARI'
                    p4='VIZIANAGARAM'
                ...
                <Content
                    titleagain='Tree Cover Loss in india'
                    info='Top 5 regions responsible for minimum tree cover loss with the first 2 regions were responsible for 72% of all tree cover loss:-'
                    p1='GUJARAT'
                    p2='CHANDIGARH'
                    p3='NCT OF DELHI'

       ...
       <div className='home'>
            <div className='home_head'>
                <div className='home_left'>
                    ...
                    <p className='home_selectone'><ArrowForwardIosIcon/>Uttrakhand<select className='home_select'>
                        <option value='meghalaya'>uttrakhand</option>
                        <Link to="/uttrakhand">
                        <option value='uttrakhand'>assam</option>
                        </Link>
                        <Link to="/meghalaya">
                    ...
                    <div className='home_statement'>
                        <p>In 2010, <strong>Uttrakhand</strong> had <strong>1.15Mha</strong> of natural forest, extending over <strong>32%</strong> of its land area. In 2020, 
                            it <strong>lost 581ha</strong> of natural forest, equivalent to <strong>305kt of CO₂</strong> of emissions.</p>
                    </div>
                </div>
            ...
            <div className='home_explore'>
                <p>Explore Graphs and basic Data information to know about the loss in the total tree cover area taken place in <b>UTTRAKHAND</b> between the years <strong>2001</strong> to <strong>2020</strong> </p>
            </div>
            <div className='home_body'>
                <Graph
                    titleone='FROM 2002 TO 2020'
                    title='Here ia a graph showing decline in the total tree cover in Uttrakhand.'
                    image='11.jpg'
                />
            ...
            <div className='home_body_two'>
                ...
                <Content
                    ...
                    info='Top 5 regions responsible for maximum tree cover loss in Uttrakhand between the years 2001 and 2020 with top 1 region were responsible for 52% of all tree cover loss between:-'
                    p1='NAINITAL'
                    p2='UDHAM SINGH NAGAR'
                    p3='CHAMPAWAT'
                    p4='UTTARKASHI'
                    p5='TEHRI GARHWAL'
                />

       ...
       <div className='home'>
            <div className='home_head'>
                <div className='home_left'>
                    ...
                    <p className='home_selectone'><ArrowForwardIosIcon/>Odisha<select className='home_select'>
                    ...
                    <div className='home_statement'>
                        <p>In 2010, <strong> Odisha</strong> had <strong>1.85Mha</strong> of natural forest, extending over <strong>12%</strong> of its land area. In 2020, 
                            it <strong>lost 8.59kha</strong> of natural forest, equivalent to <strong>3.75Mt of CO₂</strong> of emissions.</p>
                    </div>
                </div>
            ...
            <div className='home_explore'>
                <p>Explore Graphs and basic Data information to know about the loss in the total tree cover area taken place in <b>Odisha</b> between the years <strong>2001</strong> to <strong>2020</strong> </p>
            </div>
            <div className='home_body'>
                <Graph
                    titleone='FROM 2002 TO 2020'
                    title='Here ia a graph showing decline in the total tree cover in Odisha.'
                    image='11.jpg'
                />
            ...
            <div className='home_body_two'>
                ...
                <Content
                    ...
                    info='Top 5 regions responsible for maximum tree cover loss where the top 3 regions were responsible for 62% of all tree cover loss:-'
                    p1='KANDHAMAL'
                    p2='RAYAGADA'
                    p3='KALAHANDI'
                    p4='GAJAPATI'

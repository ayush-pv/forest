       ...
       <div className='home'>
            <div className='home_head'>
                <div className='home_left'>
                    ...
                    <p className='home_selectone'><ArrowForwardIosIcon/>Sikkim<select className='home_select'>
                        <option value='meghalaya'>sikkim</option>
                        <Link to="/sikkim">
                    ...
                    <div className='home_statement'>
                        <p>In 2010, <strong>Sikkim</strong> had <strong>254kha</strong> of natural forest, extending over <strong>36%</strong> of its land area. In 2020, 
                            it <strong>lost 132ha</strong> of natural forest, equivalent to <strong>62.6kt of CO₂</strong> of emissions.</p>
                    </div>
                </div>
            ...
            <div className='home_explore'>
                <p>Explore Graphs and basic Data information to know about the loss in the total tree cover area taken place in <b>SIKKIM</b> between the years <strong>2001</strong> to <strong>2020</strong> </p>
            </div>
            <div className='home_body'>
                <Graph
                    titleone='FROM 2002 TO 2020'
                    title='Here ia a graph showing decline in the total tree cover in Sikkim.'
                    image='11.jpg'
                />
            ...
            <div className='home_body_two'>
                ...
                <Content
                    ...
                    info='Top regions responsible for maximum tree cover loss in Assam between the years 2001 and 2020 with the top 2 regions were responsible for 65% of all tree cover loss:-'
                    p1='NORTH SIKKIM'
                    p2='WEST SIKKIM'
                    p3='SOUTH SIKKIM'
                    p4='EAST SIKKIM'
